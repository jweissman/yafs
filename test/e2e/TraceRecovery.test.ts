...
function manifest() {
  return '{version: 1, mounts: [{id: review, path: reviews, provider: github, config: {repository: acme/widget, pulls: {query: "is:open", max: 1}}, capabilities: [network.github-api]}]}';
}
