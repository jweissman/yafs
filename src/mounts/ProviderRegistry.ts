...
export class ProviderRegistry {
  ...
  constructor(github?: GitHubCollectionSource, authenticatedGithub?: GitHubCollectionSource,
    slack?: SlackCollectionSource) {
    const list = providerDefinitions(github, authenticatedGithub, slack)
    this.definitions = new Map(list.map(definition => [definition.name, definition]))
  }
...
function providerDefinitions(github?: GitHubCollectionSource, authenticatedGithub?: GitHubCollectionSource,
  slack?: SlackCollectionSource): ProviderDefinition[] {
  return [fixtureDefinition(), agentDefinition(), githubDefinition({ github, authenticatedGithub }),
