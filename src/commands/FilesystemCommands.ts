...
class CatCommand { readonly name = 'cat'; readonly synopsis = 'cat PATH'; readonly access = 'read'; execute(context: CommandContext, args: string[]) { return context.read(commandPath(context, args, this.name)) } }
